...
public class NewMenuRenderer extends MenuRenderer {
    ...
    private final UnitType flyerType;

    public NewMenuRenderer(){
        Time.mark();

        int cycles = new SecureRandom().nextInt(240) + 16;
        ...
        Log.debug("Randomizer cycles: @", cycles);
    }

...
/** Lightly modified version of the regular menu fragment. */
public class NewMenuFrag extends MenuFragment {
    ...
    public void build(Group parent){
        ...
        if (renderer != null) parent.fill((x, y, w, h) -> renderer.render());
